...
class Brands extends MX_Controller {
    ...
    public function fetch_data() {
        ...
        foreach ($aa_data as $row) {
            ...
            $btn_action = '';
            if($this->user_profile->get_user_access('Updated', 'brand')){
            ...
            if($this->user_profile->get_user_access('Deleted', 'brand')){
        ...
        if ($this->input->is_ajax_request()) {
            ...
            if (empty($id_brand)) {
                ...
                if ($update) {
                    ...
                    $message = "Update " . strtolower(lang('brand')) . " " .  $model->brand_name . " succesfully by " . $user->full_name;
