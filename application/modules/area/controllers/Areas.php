...
class Areas extends MX_Controller {
    ...
    public function fetch_data() {
        ...
        foreach ($aa_data as $row) {
            ...
            $btn_action = '';
            if($this->user_profile->get_user_access('Updated', 'area')){
            ...
            if($this->user_profile->get_user_access('Deleted', 'area')){
        ...
        if ($this->input->is_ajax_request()) {
            ...
            if (empty($id_area)) {
                ...
                if ($update) {
                    ...
                    $message = "Update " . strtolower(lang('area')) . " " .  $model->area_name . " succesfully by " . $user->full_name;
